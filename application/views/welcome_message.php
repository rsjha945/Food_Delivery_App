    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4">
        <div class="features-item">
          ...
          <img src="https://media.istockphoto.com/photos/interior-of-cozy-restaurant-loft-style-picture-id843610508?k=6&m=843610508&s=612x612&w=0&h=41DLQdNj3YtjIbSUQtX2zEvdJHAdHAq5c1MVS37VNzo=" class="img-responsive" alt="">
          <p>Location</p>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-3 col-md-offset-1">
        <div class="about-text">
          ...
          <p>Foodshala is an Indian restaurant aggregator and food delivery company 
          founded by Ravi Shankar Jha in 2021 Foodshala provides information, menus and  user-reviews of restaurants
           as well as food delivery options from partner restaurants in select cities .</p>
        </div>
      </div>
    </div>
  </div>
...
<div id="contact" class="text-center">
  <div class="container text-center">
    ...
    <div class="col-md-4">
      <h3>Address</h3>
      <div class="contact-item">
        <p>BENIPUR DARBHANGA</p>
        <p>BIHAR, INDIA 847103</p>
      </div>
    </div>
    <div class="col-md-4">
      <h3>Opening Hours</h3>
